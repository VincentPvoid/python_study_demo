// rsa_n可由获取http://login.shikee.com/getkey
...
// const defaultKeyObj = new RSAKeyPair("10001",'',rsa_n);

function getPwd(pwd, pubKey){
  setMaxDigits(131);
  // const rsa_n = ''
  // const key = new RSAKeyPair("10001",'',rsa_n);
  const key = new RSAKeyPair("10001",'',pubKey);
  p = encryptedString(key, pwd);
  return p;
}